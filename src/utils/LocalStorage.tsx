...
// Default Kanban columns in the starting state
...
//save the Kanban columns and tasks from localStorage
...
//load the Kanban columns and tasks from localStorage
...
//clear the Kanban data from localStorage
